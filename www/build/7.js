...
GroupsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
        selector: 'page-groups',template:/*ion-inline-start:"/Users/juan/Desktop/ITRW322-Mobile-Richard-mobile/src/pages/groups/groups.html"*/'<!--\n  Generated template for the GroupsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="hcolor">\n    <ion-title>Groups</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="addgroup()">\n        <ion-icon name="contacts"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n<ion-list no-lines>\n  <ion-list-header>\n    My Groups\n  </ion-list-header>\n  <ion-item *ngFor="let item of allmygroups">\n    <ion-avatar item-left>\n      <img src="{{item.groupimage}}">\n    </ion-avatar>\n    <h3 (click)="openchat(item)">{{item.groupName}}</h3>\n  </ion-item>\n</ion-list>\n</ion-content>'/*ion-inline-end:"/Users/juan/Desktop/ITRW322-Mobile-Richard-mobile/src/pages/groups/groups.html"*/,
    }),
